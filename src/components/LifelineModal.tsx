				...
				<div className="fixed inset-0 z-50 flex items-center justify-center p-6">
					...
					>
						...
						<div className="flex flex-col items-center text-center">
							...
							>
								<div
									className={`w-6 h-6 rounded-lg border-2 transition-all flex items-center justify-center ${dontShowAgain ? "bg-primary border-primary" : "border-white/20 group-hover:border-white/40"}`}
								>
									{dontShowAgain && (
