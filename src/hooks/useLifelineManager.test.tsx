...
const mockLifelineData = {
    freezeTime: { id: "freezeTime", name: "Freeze", description: "Stop time", icon: null },
...
describe("useLifelineManager", () => {
    ...
    it("should immediately execute action for dismissed lifeline", () => {
        ...
        expect(mockDispatch).toHaveBeenCalledWith({ type: "USE_LIFELINE", payload: { name: "skip" } });
    ...
    it("should execute pending action on modal confirm", () => {
        ...
        expect(mockDispatch).toHaveBeenCalledWith({ type: "USE_LIFELINE", payload: { name: "freezeTime" } });
